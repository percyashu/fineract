...
public class ClientSavingsIntegrationTest {
    ...
    public void testSavingsAccount_DormancyTracking() throws InterruptedException {
        ...
        for (int i = 0; i < 4; i++) {
            String TRANSACTION_DATE = formatter.format(transactionDate);
        ...
        String TRANSACTION_DATE = formatter.format(LocalDate.now());
        ...
        TRANSACTION_DATE = formatter.format(LocalDate.now());
